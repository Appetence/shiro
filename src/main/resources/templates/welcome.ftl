	...
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-header header">
			<div class="layui-main mag0">
				<a href="${basePath!}/welcome" class="logo">THIS.Blog</a>
				<!-- 显示/隐藏菜单 -->
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				...
				<p>你好！<span class="userName">${userInfo.trueName!}</span>, 欢迎登录</p>
			</div>
    ...
    layui.use(['bodyTab','form','element','layer','jquery'],function(){
        ...
        function lockPage(){
            layer.open({
                ...
                '<div class="admin-header-lock-name" id="lockUserName">${userInfo.trueName!}</div>'+
                '<div class="input_btn">'+
        ...
        $("body").on("click","#unlock",function(){
            if($(this).siblings(".admin-header-lock-input").val() == ''){
                ...
                if($(this).siblings(".admin-header-lock-input").val() == "${userInfo.password!string}"){
